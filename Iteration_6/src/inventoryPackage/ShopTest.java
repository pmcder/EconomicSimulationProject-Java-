...
public class ShopTest {
	...
	@Test
	public void testUpdateSoldItems() {
		Book book1 = new Book("Book", 5, 1, 9.99, "K", "math");
		//Book book2 = new Book("Math 1", 10, 1, 12.50, "1", "math");
		shop.updateSoldItems(book1);
		assertEquals(1, book1.getQuantitySold());
		shop.updateSoldItems(book1);
		assertEquals(2, book1.getQuantitySold());
